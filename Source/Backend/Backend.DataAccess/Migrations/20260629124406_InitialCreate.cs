    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Token", "CreatedAt", "CreatedByUserId", "Description", "ExpiresAt", "IsActive", "UsedByUserId" },
                values: new object[] { "INITIAL_SETUP_TOKEN", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Initial admin setup token", null, true, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Budgets_Account_Category_Month",
                table: "Budgets",
                columns: new[] { "AccountId", "CategoryId", "Month" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_AccountingMonth",
                table: "Transactions",
